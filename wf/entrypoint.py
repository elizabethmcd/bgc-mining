...
@nextflow_runtime_task(cpu=12, memory=36, storage_gib=100)
def nextflow_runtime(pvc_name: str, input_genomes: LatchDir, genome_metadata: LatchFile, outdir: typing_extensions.Annotated[LatchDir, FlyteAnnotation({'output': True})], antismash_db: LatchDir, pfam_db: LatchDir) -> None:
    ...
    latch_log_dir = urljoins("latch:///your_log_dir/nf_bgc_mining", exec_name)
    ...
    try:
        env = {
            **os.environ,
            ...
            "NXF_OPTS": "-Xms6912M -Xmx27648M -XX:ActiveProcessorCount=12",
...
def nf_bgc_mining(input_genomes: LatchDir, genome_metadata: LatchFile, outdir: typing_extensions.Annotated[LatchDir, FlyteAnnotation({'output': True})], antismash_db: LatchDir, pfam_db: LatchDir) -> None:
    """
    bgc-mining
    ...
    nextflow_runtime(pvc_name=pvc_name, input_genomes=input_genomes, genome_metadata=genome_metadata, outdir=outdir, antismash_db=antismash_db, pfam_db=pfam_db)
